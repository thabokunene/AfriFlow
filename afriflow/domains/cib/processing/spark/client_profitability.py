...
@description Spark-based processor for calculating CIB client profitability, providing RBAC-enforced data transformation.
@author Thabo Kunene
@created 2026-03-19
"""
...
class Processor(BaseProcessor):
    """
    Client profitability processor implementation of the BaseProcessor.
    Responsible for validating and preparing financial data for profitability analytics.
    ...
    def process_sync(self, record: Dict[str, Any]) -> Dict[str, Any]:
        """
        Synchronously processes and enriches a profitability record after validation.
