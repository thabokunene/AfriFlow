"""
@file claims_spike_detector.py
@description Flink-based processor for detecting abnormal spikes in insurance claims, providing early warnings for potential fraud or catastrophe events.
@author Thabo Kunene
@created 2026-03-19
"""
...
class Processor(BaseProcessor):
    """
    Claims spike detector implementation of the BaseProcessor.
    Ensures that streaming claims data is validated and flagged for downstream spike analysis.
    ...
    def process_sync(self, record):
        """
        Synchronously processes and flags a claims record after validation.
        
        :param record: The input record to flag.
