...
@description Insurance claims spike detector with RBAC validation and safe processed flagging
@author Thabo Kunene
@created 2026-03-17
"""
import logging
...
class Processor(BaseProcessor):
    """
    Validates claims spike inputs and marks records processed after checks.
    """
