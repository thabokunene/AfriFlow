"""
Unit tests for the Pre Meeting Client Briefing Generator.

We verify that:
1. Briefings render correctly as text.
2. Opportunities are ranked by estimated value.
3. Risk alerts map to correct domains.
4. Talking points are generated from opportunities and risks.
...
import pytest
from client_briefing.briefing_generator import (
    ClientBriefing,
    ChangeEvent,
    Opportunity,
    RiskAlert,
...
class TestClientBriefingRendering:
    """Tests for briefing text rendering."""
