...
class LekgotlaAnalytics:
    ...
    def record_thread_created(
        ...
        self._record_user_activity(author_id, today)
    ...
    def record_card_created(
        ...
        for contributor_id in contributor_ids:
            self._record_user_activity(contributor_id, today)
    ...
    def record_upvote(
        ...
        self._record_user_activity(voter_id, today)

    def record_solution_marked(
        self,
        author_id: str,
    ) -> None:
    ...
    def _record_user_activity(
        ...
        """Track unique user activity per day."""
        # Simplified - in production would use proper tracking
        pass
    ...
    def get_daily_metrics(
        ...
        metrics = []
        for date_str, metric in sorted(
            self._daily_metrics.items()
        ):
    ...
    def get_roi_attribution(self) -> Dict[str, Any]:
        ...
        won = sum(
            1 for u in self._card_usage_log if u["won"]
        )
    ...
    def get_health_score(self) -> Dict[str, Any]:
        ...
        activity_score = min(
            100, summary["avg_threads_per_day"] * 10
        )
